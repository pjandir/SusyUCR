...
#include "histio.c"
  ...
  //--------------------------------------------------------------------------------------------------------
   ...
   void draw_bg_hists2( const char* infile = "outputfiles/fill-bg-hists2.root" ) {
      ...
      savefilets.ReplaceAll( ".root", "-postdraw.root" ) ;
  ...
  //====================================================================================================================
   ...
   void draw_stack( const char* configstr, int nbi, int nji ) {
      ...
      gPad -> SetLogy(0) ;
      sprintf( fname, "outputfiles/bgplot-%s-liny.pdf", configstr ) ;
      can -> Update() ; can -> Draw() ;
      can -> SaveAs( fname ) ;

      gPad -> SetLogy(1) ;
      sprintf( fname, "outputfiles/bgplot-%s-logy.pdf", configstr ) ;
      can -> Update() ; can -> Draw() ;
      can -> SaveAs( fname ) ;
      ...
      gPad -> SetLogy(0) ;
      sprintf( fname, "outputfiles/bgplot-%s-zoom.pdf", configstr ) ;
      can -> Update() ; can -> Draw() ;
      can -> SaveAs( fname ) ;
      ...
      gPad -> SetLogy(0) ;
      sprintf( fname, "outputfiles/bgplot-%s-zoom2.pdf", configstr ) ;
      can -> Update() ; can -> Draw() ;
      can -> SaveAs( fname ) ;
      ...
      sprintf( fname, "outputfiles/bgplot-%s-frac.pdf", configstr ) ;
      can -> Update() ; can -> Draw() ;
      can -> SaveAs( fname ) ;
